f = open("C:\Users\306\Downloads\access.log", "r") print(f.read()) from os import access import requests import re respuesta = requests.get(access.log)

if respuesta.status_code == 200: logs = respuesta.text
...
else: print(f"Error al obtener los logs. Código de estado: {respuesta.status_code}")
